...
class MachineLearning:
    ...
    def train_models(self):
        ...
        p = Process(target=self.build_cnn_ask, args=())
        p.start()
        p2 = Process(target=self.build_lstm_bid, args=())
        p2.start()
        p3 = Process(target=self.build_cnn_bid, args=())
        p3.start()
        p4 = Process(target=self.build_lstm_ask, args=())
        p4.start()
        p.join()
        p2.join()
        p3.join()
